...
<head>
    ...
    <meta property="og:url" content="{{ asset('') }}program/kerja" />
...
<body data-scroll-index="0" class="onloading">
    ...
    <section class="jumbotron jumbotron-program-kerja">
        <h1>PROGRAM KERJA</h1>
    </section>

    <section class="program-kerja">
        <div class="program-kerja-1"></div>
        <div class="program-kerja-2">
        ...
        <div class="program-kerja-3">
            <div class="container">
                <div class="row">
                    @foreach ($Departemen as $departemen)
                        <div class="col-md-6">
                            <a class="card" href="/program-kerja/{{ $departemen['departemen'] }}">
                                <img src="{{ $departemen['gambar_departemen'] }}" alt="" srcset="">
