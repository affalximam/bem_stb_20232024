...
<head>
    ...
    <title>DOKUMENTASI - BEM STB 2024</title>
    ...
    <meta property="og:url" content="{{ asset('') }}dokumentasi" />
...
<body data-scroll-index="0" class="onloading">
    ...
    <section class="jumbotron jumbotron-dokumentasi">
        <h1>DOKUMENTASI</h1>
    </section>

    <section class="dokumentasi">
        <div class="dokumentasi-1"></div>
        <div class="dokumentasi-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a class="card" href="/dokumentasi/{{ $dokumentasi['nama_dokumentasi'] }}">
                            ...
                            <p>{{ $dokumentasi['formatted_date'] }}</p>
                        </a>
                    </div>
                    @endforeach
                </div>
