...
<body data-scroll-index="0" class="onloading">
    ...
    <section class="dashboard-admin pb-5">
        <div class="container">
            <div class="row">
                <h1 class="text-center pt-2 pb-5">EDIT PROKER [ {{ $prokerBem->nama_departemen }} ]</h1>
            </div>
            <form action="{{ route('admin.update_proker_bem') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-xl-6">
                        <h2>Upload Gambar</h2>
                    ...
                    <div class="col-xl-12">
                        <h2>Program Kerja</h2>
                        <textarea class="form-control h-50 textarea" id="floatingTextarea" name="program_kerja_departemen">{{ $prokerBem->proker_departemen }}</textarea>
                    </div>
