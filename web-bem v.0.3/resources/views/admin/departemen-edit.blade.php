...
<body data-scroll-index="0" class="onloading">
    ...
    <section class="dashboard-admin pb-5">
        <div class="container">
            <div class="row">
                <h1 class="text-center pt-2 pb-5">EDIT DEPARTEMEN [ {{ $Departemen->nama_departemen }} ]</h1>
            </div>
            <form action="{{ route('admin.update_departemen', $Departemen->id_departemen) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-xl-6">
                        <h2>Nama Departemen</h2>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control input-lg" id="floatingInput" name="nama_departemen" value="{{ $Departemen->nama_departemen }}">
                    ...
                    <div class="col-xl-6">
                        <h2>Upload Gambar</h2>
                        <div class="mb-3">
                            <input class="form-control" type="file" id="formFile" name="gambar_departemen">
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <h2>Program Kerja</h2>
                        <textarea class="form-control h-50 textarea" id="floatingTextarea" name="program_kerja_departemen">{{ $Departemen->proker_departemen }}</textarea>
                    </div>
