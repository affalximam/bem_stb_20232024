...
<body data-scroll-index="0" class="onloading">
    ...
    <section class="dashboard-admin pb-5">
        <div class="container">
            <div class="row">
                <h1 class="text-center py-2">DEPARTEMEN</h1>
            </div>
            <div class="row">
                @foreach ($Departemen as $departemen)
                    <div class="col-md-6 p-3">
                        ...
                        <div class="row p-3">
                            <div class="col-4">
                                <img src="{{ $departemen['gambar_departemen'] }}" alt="" class="w-100">
                            </div>
                            <div class="col-8">
                                <h2 class="fs-3">{{ $departemen['nama_departemen'] }}</h2>
                                <div class="row">
                                    <a href="/admin/departemen/edit/{{ $departemen['id_departemen'] }}" class="btn btn-sm w-auto m-2 text-black btn-warning">
